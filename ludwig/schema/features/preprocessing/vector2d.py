...
from ludwig.constants import BFILL, IMAGE, IMAGENET1K, MISSING_VALUE_STRATEGY_OPTIONS, PREPROCESSING, VECTOR2D
...
@ludwig_dataclass
class Vector2dPreprocessingConfig(BasePreprocessingConfig):
    missing_value_strategy: str = schema_utils.StringOptions(
        MISSING_VALUE_STRATEGY_OPTIONS,
        default=BFILL,
        allow_none=False,
        description="What strategy to follow when there's a missing value in an image column",
        parameter_metadata=FEATURE_METADATA[VECTOR2D][PREPROCESSING]["missing_value_strategy"],
    )
    ...
    fill_value: float = schema_utils.NonNegativeFloat(
        ...
        parameter_metadata=FEATURE_METADATA[VECTOR2D][PREPROCESSING]["fill_value"],
    )
    ...
    computed_fill_value: float = schema_utils.NonNegativeFloat(
        ...
        parameter_metadata=FEATURE_METADATA[VECTOR2D][PREPROCESSING]["computed_fill_value"],
    )
    ...
    height: Optional[int] = schema_utils.PositiveInteger(
        ...
        parameter_metadata=FEATURE_METADATA[VECTOR2D][PREPROCESSING]["height"],
    )
    ...
    width: Optional[int] = schema_utils.PositiveInteger(
        ...
        "first image in the dataset.",
        parameter_metadata=FEATURE_METADATA[VECTOR2D][PREPROCESSING]["width"],
    )
    ...
    num_channels: int = schema_utils.PositiveInteger(
        ...
        parameter_metadata=FEATURE_METADATA[VECTOR2D][PREPROCESSING]["num_channels"],
    )
    ...
    resize_method: str = schema_utils.StringOptions(
        ...
        parameter_metadata=FEATURE_METADATA[VECTOR2D][PREPROCESSING]["resize_method"],
    )
    ...
    infer_image_num_channels: bool = schema_utils.Boolean(
        ...
        "in the dataset.",
        parameter_metadata=FEATURE_METADATA[VECTOR2D][PREPROCESSING]["infer_image_num_channels"],
    )
    ...
    infer_image_dimensions: bool = schema_utils.Boolean(
        ...
        parameter_metadata=FEATURE_METADATA[VECTOR2D][PREPROCESSING]["infer_image_dimensions"],
    )
    ...
    infer_image_max_height: int = schema_utils.PositiveInteger(
        ...
        "the dataset.",
        parameter_metadata=FEATURE_METADATA[VECTOR2D][PREPROCESSING]["infer_image_max_height"],
    )
    ...
    infer_image_max_width: int = schema_utils.PositiveInteger(
        ...
        "the dataset.",
        parameter_metadata=FEATURE_METADATA[VECTOR2D][PREPROCESSING]["infer_image_max_width"],
    )
    ...
    infer_image_sample_size: int = schema_utils.PositiveInteger(
        ...
        parameter_metadata=FEATURE_METADATA[VECTOR2D][PREPROCESSING]["infer_image_sample_size"],
    )
    ...
    standardize_image: Union[str, None] = schema_utils.StringOptions(
        ...
        parameter_metadata=FEATURE_METADATA[VECTOR2D][PREPROCESSING]["standardize_image"],
    )
    ...
    in_memory: bool = schema_utils.Boolean(
        ...
        parameter_metadata=FEATURE_METADATA[VECTOR2D][PREPROCESSING]["in_memory"],
    )
    ...
    num_processes: int = schema_utils.PositiveInteger(
        ...
        parameter_metadata=FEATURE_METADATA[VECTOR2D][PREPROCESSING]["num_processes"],
    )

    requires_equal_dimensions: bool = schema_utils.Boolean(
        default=False,
        description="If true, then width and height must be equal.",
        parameter_metadata=FEATURE_METADATA[VECTOR2D][PREPROCESSING]["requires_equal_dimensions"],
    )
